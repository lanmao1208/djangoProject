...
class ProjectsModels(models.Model):
    ...
    names = models.CharField(max_length=60, verbose_name='项目名称', help_text='项目名称', unique=True)
    ...
    testers = models.CharField(max_length=200, verbose_name='测试人员', help_text='测试人员', blank=True, null=True)
