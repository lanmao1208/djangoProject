    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('project', models.ForeignKey(help_text='所属项目', on_delete=django.db.models.deletion.CASCADE, related_name='project', to='projects.projectsmodels', verbose_name='所属项目')),
            ],
            options={
                'verbose_name': '接口信息',
